...
// #task1.  map funksiyasi ile sadece bu obyektin id, username ve email-inden ibaret obyektlerden teskil olunmus  yeni bir array yaradin: mes: 
// [  {id:1, username: 'Bret', email: "incere@april.biz"   ]

// const newArray = persons.map((obj) => {
//     let newObj = {
//         id: obj.id,
...
// ⚠️. Arrayi loop (dovr) etmek lazimdir. Calisin, forEach methodu ile edin. 

// persons.forEach((elem) => {
//     document.write(`Username : ${elem.username} <br> Email : ${elem.email} <br> Company Name : ${elem.company.name} <br> <hr>`)
// })
...
//     const netice = persons.find((elem) => {
